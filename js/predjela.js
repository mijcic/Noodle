...
[
	...
	['Kineski rezanci','Chinese noodles'], 
	['Salata sa škampima','Shrimp Salad'], 
	['Pileći dumplings','Chicken Dumplings'], 
	['Šnicle od mlevenog mesa','Minced meat steaks'], 
	['Kiselo-ljuta čorba','Sour and spicy broth']
];
let pricesM = ['280.00', '850.00', '950.00', '1150.00', '900.00', '760.00'];
let pricesV = ['400.00', '1000.00', '1450.00', '1550.00', '1200.00', '960.00'];
let pricesNum = [280, 850, 950, 1150, 900, 760];
let images = ['koriscene_slike/spring-rolls-with-dipping-sauces-scaled.jpg', 'koriscene_slike/chinese-noodles.jpeg', 'koriscene_slike/shrimp-salad.jpeg', 'koriscene_slike/chicken-dumplings.jpeg', 'koriscene_slike/chinese-meatballs.png', 'koriscene_slike/hot-and-sour-soup.jpg'];
let ingredients_lang = 
[
	['piletina/svinjetina/junetina, šargarepa, crveni luk, kukuruz, kupus','chicken/pork/beef, carrot, red onion, corn, cabbage'], 
    ['šargarepa, crvena paprika, crni luk, beli luk, mladi luk, grašak, brokoli','carrot, red pepper, onion, garlic, spring onion, pea, broccoli'], 
    ['ajsberg, crveni luk, čeri, škampi, avokado, parmezan','iceberg, red onion, cherry, shrimp, avocado, parmesan'], 
    ['piletina, paprika, crni luk, šargarepa, celer, beli luk','chicken, pepper, onion, carrot, celery, garlic'], 
    ['junetina, persun, crvena paprika, korijander, jaje','beef, parsley, red pepper, coriander, egg'], 
    ['pileća supa, sirće, soja sos, paprika, pečurke, šargarepa','chicken soup, vinegar, soy sauce, paprika, mushrooms, carrots']
	];
let names = [];
let ingredients = [];
// // dodatak kraj
