...
let pricesM = ['995.00', '1155.00', '835.00', '1300.00', '1350.00', '860.00'];
let pricesV = ['1300.00', '1450.00', '1000.00', '1550.00', '1650.00', '1100.00'];
let pricesNum = [995, 1155, 835, 1300, 1350, 860];
let images = ['koriscene_slike/chicken-with-peanuts.jpg', 'koriscene_slike/pork-with-leek.png', 'koriscene_slike/mixed-vegetables.jpeg', 'koriscene_slike/spiced-tofu.jpg', 'koriscene_slike/spicy-chicken.webp', 'koriscene_slike/cabbage.jpg'];

// // dodatak pocetak
let names_lang = [
	['Piletina sa kikirikijem', 'Chicken with peanuts'], 
	['Svinjetina sa prazilukom', 'Pork with leeks'], 
	['Mešano povrće', 'Mixed Vegetables'], 
	['TOFU kuvan u 5 začina sa svinjetinom', 'TOFU cooked in 5 spices with pork'], 
	['Hrskava piletina u slatko-ljutom sosu', 'Crispy chicken in sweet and spicy sauce'], 
	['Prženi kupus u kiselo-ljutom sosu', 'Fried cabbage in sour-hot sauce' ]
	];
let ingredients_lang = [
		['piletina, kikiriki, indijski orah, beli pirinač, šargarepa, krastavac','chicken, peanuts, cashews, white rice, carrots, cucumber' ], 
        ['svinjetina, zelena paprika, praziluk, limun','pork, green pepper, leek, lemon'], 
        ['grašak, boranija, krompir, šargarepa, celer, crni luk, paradajz, crvena paprika', 'peas, green beans, potatoes, carrots, celery, onions, tomatoes, red peppers'], 
        ['tofu, svinjetina, čili paprika, paradajz, limun, zelena paprika', 'tofu, pork, chili peppers, tomatoes, lemons, green peppers'], 
        ['piletina, med, čili paprika, pirinač, praziluk', 'chicken, honey, chili peppers, rice, leeks'], 
        ['kiseli kupus, slanina, čili paprika', 'sauerkraut, bacon, chili pepper']
		];
let names = [];
let ingredients = [];
// // dodatak kraj
